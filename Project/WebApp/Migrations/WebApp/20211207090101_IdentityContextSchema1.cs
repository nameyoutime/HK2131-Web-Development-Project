...
{
    public partial class IdentityContextSchema1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    promotion_price = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<int>(type: "int", nullable: false),
                    order_date = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: true),
                    total = table.Column<int>(type: "int", nullable: true),
                    status = table.Column<int>(type: "int", nullable: true),
                    customer_id = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    ship_address = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: true),
